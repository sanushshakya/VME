...
const UserEvent = () => {
    ...
    useEffect(()=>{
        ...
        try{
            ...
            const resPar = await axios.get(`http://localhost:8000/api/participants/read_event_participated_by_user/${resUser.data._id}`)
            setEvt(resPar.data)
            const resEvt = await axios.get(`http://localhost:8000/api/events/read_by_user/${resUser.data._id}`)
