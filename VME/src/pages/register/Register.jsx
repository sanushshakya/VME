...
const Register = () => {
  ...
  useEffect(()=>{
    const fetchData = async() => {
        try{
            const response = await axios.get(`http://localhost:8000/api/role/read`)
  ...
  return (
    <div className='register'>
      <div className="container">
        <div className="left">
          <Link to="/" className='link links'>VME</Link>
          <h1>NAMASTE</h1>
          <img src="./img/featured1.png"/>
          <h3>Manage your work<br/>effectively with us</h3>
        </div>
        <div className="right">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="credentials">
              ...
              <span>
                <input {...register('team_name')} type="text" placeholder='Enter your Team Name'/>
              </span>
              {errors.team_name && (
                <span className="error-message">{errors.team_name.message}</span>
              )}
              <span>
                <div className="list">
